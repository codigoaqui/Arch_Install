...
mkfs.vfat -F 32 /dev/sda1  o  mkfs.ext2 /dev/sda1  # Para partición /boot
...
mount /dev/sda1 /mnt/boot                          # montamos la partición boot en el directorio
mkdir /mnt/home                                    # creamos el directorio para home
mount /dev/sda4 /mnt/home                          # montamos la partición home en el directorio

-------- INSTALAR EL SISTEMA BASE ---------

pacstrap /mnt linux linux-firmware nano grub networkmanager wpa_supplicant base base-devel dhcpcd netctl dialog
